...
import com.betterthannoobs.codeutsava.hackathon.blooddonorapp.utils.mapsutils.GetNearbyPlacesData;
...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback, GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener, LocationListener {
    ...
    public void showingNearbyBloodBanks() {
        Object dataTransfer[] = new Object[2];
        GetNearbyPlacesData getNearbyPlacesData = new GetNearbyPlacesData();
        mMap.clear();
        String bloodbank = "hospital";
        String url = getUrl(latitude, longitude, bloodbank);
        dataTransfer[0] = mMap;
        dataTransfer[1] = url;
    ...
    private String getUrl(double latitude , double longitude , String nearbyPlace)
    {
        ...
        googlePlaceUrl.append("&key="+"AIzaSyDql_VLU7gtfFkzoNI1xsh451Vz70_58l8");
